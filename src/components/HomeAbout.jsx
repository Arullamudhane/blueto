    ...
    <Section id='how-to-use '>
      <div className='container   '>
        ...
        <div className='relative '>
          <div
            className='relative z-1  flex items-center h-[60rem] mb-5 p-8 md:p-1 border
           border-stone-700 rounded-3xl overflow-hidden lg:p-20 md:h-[44rem] lg:h-[44rem]  '
          >
            ...
            >
              ...
              <p className='my-0  '>
                <div class='bg-gradient-to-r from-purple-800 via-black-400  to-black-400 p-4  rounded-xl'>
                  <blockquote
                    class='border-l-4 border-blue-500 pl-4 italic text-white
                   text-bold tracking-widest'
                  >
