...
const ContactHomePage = () => {
  return (
    <div className=' mt-10 '>
      <div
        className='mx-auto lg:mx-20 lg:mr-28 border-2 
       border-blue-800/50 rounded-2xl shadow-2xl py-5
        text-slate-100 flex flex-col lg:flex-row  items-center justify-center 
        space-y-3   lg:space-y-0 px-10  lg:justify-evenly'
      >
