...
const Home = () => {
  ...
  return (
    <Bounded ref={component} className='md:py-0 lg:py-0  '>
      <div
        className=' max-h-screen  lg:max-h-[90vh]    grid  grid-cols-1 lg:grid-cols-2 
         items-center 
      md:-mt-20 lg:-mt-36 md:mb-0  relative  '
      >
        <Shapes />

        <div className=' col-start-1 md:row-start-1 -mt-10 md:mt-0 '>
          <h1
            className='mb-8 text-[clamp(3rem,20vmin,20rem)] md:text-7xl lg:text-[clamp(3rem,20vmin,20rem)] font-extrabold md:font-bold  lg:font-extrabold leading-none mt-0 '
